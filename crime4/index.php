...
<?php include('modal_add.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from dep_head order by Head1 ASC" ) or die (mysql_error());
								...
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['Head1']; ?></td>
