...
<br>
 ...
 '.str_repeat("&nbsp;",8).' and departure '.str_repeat("&nbsp;", 23).' {Saturdays'.str_repeat("_",10).'
	...
	<p style="text-align:justify; font-family:arial; font-size: 13px;">'.str_repeat("&nbsp;",5).'I  CERTIFY <i> my <i> honor <i> that the  above  is  a  true and correct <br>report
	  of the hours <i> of work performed, <i> record <i> of which <i>was<br> made daily at
