...
$result1 = dbquery($con1,("SELECT * FROM userinfo_copy_copy a LEFT JOIN dep_head_copy b ON a.Deptcode=b.id WHERE b.id in 
($ID)
ORDER BY a.Deptcode 
;"));
...
<br>
 ...
 <br>
 <br>
 <p style="padding-left: 10px; font-family:arial; font-size: 12px;"> For the month of '.str_repeat("_",7).'<u><b>'.$date.' '.$me.' - '.$me1.', '.$me2.'</b></u>'.str_repeat("_",14).'<br> 	
