...
$mpdf=new mPDF('win-1252','A4','','',18,15,2,2,2,2);
...
//list($ID1)=getarray($con1,("SELECT * FROM dept_head where Deptcode=$ID order by id desc limit 1;"));
...
<br>
 <p style="padding-left: 140px;  font-family:arial; font-size: 18px;">'.str_repeat("&nbsp;",$ff).'<u>'.$name.'</u>
 <p style="font-size=3px">'.str_repeat("&nbsp;",20).'(Name)</p>
 <p style="padding-left: 10px; font-family:arial; font-size: 12px;"> For the month of '.str_repeat("&nbsp;",6).'<b><u>'.$date.' '.$me.' - '.$me1.', '.$me2.'</u></b><br> 	
 Official hours for arrival<b>'.str_repeat("&nbsp;", 14).'</b> {Regular days'.str_repeat("_",7).'<br>
 '.str_repeat("&nbsp;",8).' and departure '.str_repeat("&nbsp;", 23).' {Saturdays'.str_repeat("_",8).'
	</td>
	</tr>
	</table>
	</EM></CAPTION>
	...
	<table style="border-collapse: collapse;"  width="10px">
       ...
       <TR>
        ...
        <th><b><br>    </b><th><b><i> <i><br><i>'.str_repeat("&nbsp;", 5).'<i></b>
			...
			{                    
			$html = $html .'<tr font-family: sans-serif; font-size: 8pt;>
    ...
    'I  CERTIFY on my honor that  the  above  is  a  true  and<br>
    correct report of the hours of work performed, record <br>
    of <i> which <i> was <i> made daily <i> at <i> the  time of arrival and  <br>
    departure from office.</i> </p>
...
$html .='<p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px">' .str_repeat("&nbsp;",$spc0). '<u><b>' .$head. '<b></u><br>'.str_repeat("&nbsp;",$ee). ''.$head1 .'</p>
