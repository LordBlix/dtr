                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">Tradename</th>
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from maclearance where action is null order by permitNo ASC" ) or die (mysql_error());
								...
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo str_pad($row['permitNo'],3,'0',STR_PAD_LEFT)."-2019"; ?></td>
								<td style="text-align:center; word-break:break-all; width:400px;"> <?php echo $row ['tradeName']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['client']; ?></td>
								...
								<td style="text-align:center; width:350px;">
									<a href="edit.php<?php echo '?id='.$id; ?>" class="btn btn-info">Edit</a>
									 <a href="#delete<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" >Assign BP </a>
								...
								<p><div class="alert alert-danger">Are you Sure you want to print? Business permit <?php echo $use; ?></p>
								<form method="post" action="add2.php<?php echo '?id='.$id; ?>">
								<label style="color:#3a87ad; font-size:18px;">Business Permit No.</label>
								<input type="text" name="taxPayer" placeholder="Taxpayer" required />
								<label style="color:#3a87ad; font-size:18px;">Amount</label>
								<input type="text" name="paid" placeholder="Amount" required />
