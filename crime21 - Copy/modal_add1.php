...
?>
    ...
    <div class="modal-body">
					...
					<table class="table1">
						...
						<tr>
							<td><label style="color:#3a87ad; font-size:18px;">OR No.</label></td>
							<td width="30"></td>
							<td><input type="text" name="address1" placeholder="Address" /></td>
						</tr>
						<tr>
							<td><label style="color:#3a87ad; font-size:18px;">OR Date</label></td>
							<td width="30"></td>
						...
						<tr>
							...
							<td width="30"></td>
							<td><input type="text" name="date" placeholder="Address" /></td>
						</tr>
						<tr>
							<td><label style="color:#3a87ad; font-size:18px;">CTC Date</label></td>
							<td width="30"></td>
							<td><input type="text" id="datepicker1" name="ctcNo"/></td>
						</tr>
						<tr>
