...
$result1 = dbquery($con1,("SELECT * FROM userinfo_copy where ID in (101,32,125,131,90,60)
;"));
...
Date2, DATE_FORMAT(Date1, '%M'), DATE_FORMAT(Date1, '%e'), DATE_FORMAT(Date2, '%e'), DATE_FORMAT(Date2, '%Y')
 FROM dtrme ORDER BY id DESC LIMIT 1;"));
$date=$mo;
$me=$d8;
$me1=$d8f;
$me2=$yr;
...
//request require code code code code code;

//request code code code code code;
//request code code code code mysql_connect('localhost','root','');
//mysql_query($con1,("select * from userinfo_copy where title='2';"));
//mysql_dbquertt($con1,("select * from userinfo_copy where title='3'"));
...
<br>
 ...
 '.str_repeat("&nbsp;",8).' and departure '.str_repeat("&nbsp;", 23).' {Saturdays'.str_repeat("_",10).'
    ...
    <p style="text-align:justify; font-family:arial; font-size: 13px;">'.str_repeat("&nbsp;",5).'I  CERTIFY my honor <i> that the  above  is  a  true and correct
    report of the hours <i> of work <i> performed, record of <br>which was made daily at
