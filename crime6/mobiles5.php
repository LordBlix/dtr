...
function getarray($con1, $query){
 ...
 $mpdf=new mPDF('win-1252', [305,216],'','',2,2,2,2,2,2);
...
list($taruc, $name,$head, $head1, $ee, $ff, $fs, $spc0)=getarray($con1, ("SELECT NAME, b.userid, b.Head1, b.Head2, b.spc, SSN, b.fs, b.spc0 FROM 
...
$html1 = $html1 .'<p style="font-family:arial; font-size: 10px;">Civil Service Form No. 48</p>';
$html1 = $html1 .'<p style="padding-left: 20px; font-family:arial; font-weight:bold; font-size: 16px">'.str_repeat("&nbsp;",16).'DAILY TIME RECORD </p>';
$html1 = $html1.'<p style="padding-left: 100px; font-family:arial; font-size=19px">'.str_repeat("&nbsp;",15).'-----o0o-----</p>';
$html1 = $html1.' <p style="padding-left: 20px;  font-family:arial; font-size: 18px;">'.str_repeat("&nbsp;",$ff).'<u>'.$name.'</u>';
$html1 = $html1.'<p style="">'.str_repeat("&nbsp;",35).'(Name)</p>';
$html1 = $html1.'<p style="padding-left: 10px; font-family:arial; font-size: 12px;"> For the month of '.str_repeat("&nbsp;",6).'<b><u>'.$date.' '.$me.' - '.$me1.', '.$me2.'</u></b><br>';	
$html1 = $html1.'Official hours for arrival<b>'.str_repeat("&nbsp;", 22).'</b> {Regular days'.str_repeat("_",7).'<br>
 '.str_repeat("&nbsp;",8).' and departure '.str_repeat("&nbsp;", 32).' {Saturdays'.str_repeat("_",8).'
	...
	<table style="border-collapse: collapse;"  width="10px">
        <thead>
        <tr>
        <td colspan="4" style=" font-family:arial; font-size:10px; ">Civil Service Form No. 48
        <tr>
        <td colspan="3" style="font-size:17px; ">'.str_repeat("&nbsp;",6).'
        <tr>
        <td colspan="2" style="font-family:arial; font-size:12px; font-weight:bold; "><td colspan="4" style="font-size:16px; "><b>DAILY TIME RECORD<b>
        <tr>
        <td colspan="3" style="font-size:17px; ">'.str_repeat("&nbsp;",6).'
        <tr>
        <td colspan="3" style="font-size:12px; "><td colspan="4" style="font-size:17px; ">-----o0o-----
        <tr>
        <td colspan="3" style="font-size:17px; ">'.str_repeat("&nbsp;",6).'
        <tr>
        <td colspan="3" style="font-size:12px; ">
        <tr>
        <td colspan="1" style="font-size:12px; "><td colspan="7" style="font-size:18px; ">'.str_repeat("&nbsp;",$ff).'<u>'.$name.'</u>
        <tr>
        <td colspan="3" style="font-size:12px; ">
        <td colspan="3" style="font-size:17px; ">(Name)
        <tr>
        <td>'.str_repeat("&nbsp;",6).'
        <tr>
        <td colspan="1" style="font-size:12px; ">
        <td colspan="5" style="font-size:12px; ">For the month of '.str_repeat("&nbsp;",6).'<b><u>'.$date.' '.$me.' - '.$me1.', '.$me2.'</u></b>
        <tr>
        <td colspan="3" style="font-size:12px; ">Official hours for arrival
        <td colspan="1">
        <td colspan="3" style="font-size:12px; ">{Regular days'.str_repeat("_",7).'
        <tr>       
        <td colspan="3" style="font-size:12px; ">and departure
        <td colspan="1">
        <td colspan="3" style="font-size:12px; ">{Saturdays'.str_repeat("_",8).'
        <tr>
...
<tbody>';
                            ...
                            <tr>
                            <td colspan="2" style="font-size:15px; ">'.str_repeat("&nbsp;",6).'
                            <td colspan="4" style="font-size:15px; "><b>TOTAL</b>'.str_repeat("_",20).'
                            <tr>
                            <td colspan="7" style="font-size:13px; ">I  CERTIFY on my honor that  the  above  is  a  true  and correct
                            report of the hours of work performed, record of which was made daily at the  time of arrival and
                            departure from office.
                            <tr>
                            <td colspan="2" style="font-size:10px; ">'.str_repeat("&nbsp;",1).'
                            <td colspan="3" style="font-size:12px; ">'.str_repeat("_",36).'
                            <tr>
                            <td colspan="2" style="font-size:10px; ">'.str_repeat("&nbsp;",1).'
                            <tr>
                            <td colspan="1" style="font-size:10px; ">'.str_repeat("&nbsp;",1).'
                            <td colspan="7" style="font-size:15px; ">Verified as to the prescribed office hours.
                            <tr>
                            <td colspan="2" style="font-size:10px; ">'.str_repeat("&nbsp;",1).'
                            <tr>
                            <td colspan="7" style="font-size:20px; ">'.str_repeat("-",65).'
                            <tr>
                            <td colspan="2" style="font-size:10px; ">'.str_repeat("&nbsp;",1).'
                            <tr>
                            <td colspan="2" style="font-size:20px; ">'.str_repeat("&nbsp;",1).'
                            <tr>
                     
                            
                            
                            
                            <td colspan="2" style="font-size:15px; ">'.str_repeat("&nbsp;",1).'
                            <td colspan="7" style="font-size:14px; "><u><b>' .$head. '<b></u>
                            <tr>
                            <td colspan="2" style="font-size:15px; ">'.str_repeat("&nbsp;",1).'
                            <td colspan="4" style="padding-left: 48px; font-size:15px; ">'.$head1 .'
                            <tr>
                          <td>
                            <td>
                            <tr>
                            ...
                            $html1=$html1.'
                            <tr>
                            <td colspan="" style="font-size:17px; ">'.str_repeat("&nbsp;",6).'
                            <tr>
                            <td colspan="1" style="font-size:17px; ">I  CERTIFY on my honor that  the  above  is  a  true  and correct
                        ...
                        $html1 =$html1.'<br><p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px">' .str_repeat("&nbsp;",$spc0). '<u><b>' .$head. '<b></u><br>'.str_repeat("&nbsp;",$ee). ''.$head1 .'</p>
                        <p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px"></p>
                        <p style="text-align:left; padding-left:25px; font-family:arial; font:size:10px"><b><i></b><br><br><br><br><br><br><br><br><br><br></p>
                        <columnbreak/>';
