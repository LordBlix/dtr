...
function getarray($con1, $query){
 ...
 $mpdf=new mPDF('win-1252', array(480,322),'','',2,2,2,2,2,2);
...
$html1 = $html1.' <p style="font-family:arial; font-size: 18px;">'.str_repeat("&nbsp;",$ff).'<u>'.$name.'</u>';
...
$html1 = $html1.'Official hours for arrival<b>'.str_repeat("&nbsp;", 22).'</b> {Regular days'.str_repeat("_",7).'<br>
 '.str_repeat("&nbsp;",8).' and departure '.str_repeat("&nbsp;", 32).' {Saturdays'.str_repeat("_",8).'
	...
	<table style="border-collapse: collapse;"  width="10px">
        ...
        <tr>
        <td colspan="0" style="font-size:17px; ">'.str_repeat("&nbsp;",6).'
        <tr>
...
<tbody>';
                            ...
                            <tr>
                            <td align="justify" colspan="7" style="font-size:13px; ">I  CERTIFY on my honor that  the  above  is  a  true  and correct
                            ...
                            <tr>
                            <td align="center" colspan="8" style="font-size:10px; ">'.str_repeat("&nbsp;",1).'
                            <tr>
