...
$roche1="select title from userinfo_copy where id=$use;";
$result1= mysqli_query($con1,$roche1);
list($tala)=mysqli_fetch_array($result1);
//echo "$tala";
$date=$mo;
$me=$d8;
$me1=$d8f;
...
'.str_repeat("&nbsp;",30).''.str_repeat("_",20).'</p><br>';
}

if($tala==2){
$html .='<p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px">' .str_repeat("&nbsp;",22). '<u>' .$head. '</u><br>' .str_repeat("&nbsp;",12). '<b>'.$head1 .'</b></p>';
$html .='<p style="text-align:left; padding-left:25px; font-family:arial; font:size:10px">(See instructions on back)'.str_repeat("&nbsp;",9).'<b><i>In Charge</i></b></p>
...
if($tala==2)
echo 
"<p style=text-align:left; padding-top:-10; font-family:arial;font-size:-1px><br>
<br>".str_repeat("&nbsp;",19)."<u>".$head."</u><br>".str_repeat("&nbsp;",35)."<b>".$head1."</b>
</br></p>
";

if ($tala==1)
echo "<p style=text-align:right: 80px; padding-top:-10px; font-family:arial; 
font-size:-1px></p>".str_repeat("&nbsp;",30).str_repeat('_',20); ?>

<p style="text-align:left; padding-left:25px; font-family:arial; font:size:10px">(See instructions on back)

<?php if ($tala==1) 
echo str_repeat("&nbsp;",3)."<b><i>In Charge</i></b></p>"; ?>
</html>