<?php
  ...
  $sql      = "SELECT * FROM (
    ...
    SELECT b.DATE model_no, e.clock1   mobile_name, b.clock2 price, b.clock3 company, b.clock4 mobile_category FROM (
...
<p style="padding-left: 90px; font-family:arial; font-weight:bold; font-size: 16px">DAILY TIME RECORD </p>
<p style="padding-left: 120px; font-family:arial; font-size=19px">-----o0o-----</p>
<p style="padding-left: 140px;  font-family:arial; font-size: 18px;"><u><?php echo $name ?></u><br style="font-size=12px">(Name)</p>
