...
list($use, $date1, $Date2, $mo, $d8, $d8f, $yr)=mysqli_fetch_array($result);
...
list($d8f)=mysqli_fetch_array(mysqli_query($con1,$n3));
    ...
    <?php
      ...
      <p style="text-align:justify; font-family:arial; font-size: 13px;">'.str_repeat("&nbsp;",5).'I CERTIFY <i>on my honor that the above is a true<br> and correct report
        ...
        <p style="text-align:left; padding-left:20px; font-family:arial; font:size:10px">Verified as to the prescribed office hours.</p><br>
        <p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px">' .str_repeat("&nbsp;",17). '<u>KARISSA R. FETALVERO-PARONIA</u><br>' .str_repeat("&nbsp;",32). '<b>Municipal Mayor</b></p>
    
<p style="text-align:left; padding-left:25px; font-family:arial; font:size:10px">(See instructions on back)'.str_repeat("&nbsp;",9).'<b><i></i></b></p>
      ...
      //<p style="text-align:left; padding-left:200px; font-family:arial; font:size:10px">(See instructions on back)'.str_repeat("_",40).'<b><i></i></b></p>    
...
<p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px"><?php echo str_repeat("&nbsp;",17)?> <u>KARISSA R. FETALVERO-PARONIA</u><br><?php echo str_repeat("&nbsp",32) ?><b>Municipal Mayor</b></p>
