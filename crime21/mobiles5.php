...
function getarray($con1, $query){
  ...
  $mpdf=new mPDF('win-1252','Legal','','',2,2,2,2,2,2);
...
$html2 = $html2 .'<p style="font-family:arial; font-size: 10px;">Civil Service Form No. 48</p>';
$html2 = $html2 .'<p style="padding-left: 20px; font-family:arial; font-weight:bold; font-size: 16px">'.str_repeat("&nbsp;",16).'DAILY TIME RECORD </p>';
$html2 = $html2.'<p style="padding-left: 100px; font-family:arial; font-size=19px">'.str_repeat("&nbsp;",15).'-----o0o-----</p>';
$html2 = $html2.' <p style="padding-left: 20px;  font-family:arial; font-size: 18px;">'.str_repeat("&nbsp;",$ff).'<u>'.$name.'</u>';
$html2 = $html2.'<p style="">'.str_repeat("&nbsp;",35).'(Name)</p>';
$html2 = $html2.'<p style="padding-left: 10px; font-family:arial; font-size: 12px;"> For the month of '.str_repeat("&nbsp;",6).'<b><u>'.$date.' '.$me.' - '.$me1.', '.$me2.'</u></b><br>';	
$html2 = $html2.'Official hours for arrival<b>'.str_repeat("&nbsp;", 22).'</b> {Regular days'.str_repeat("_",7).'<br>
 '.str_repeat("&nbsp;",8).' and departure '.str_repeat("&nbsp;", 32).' {Saturdays'.str_repeat("_",8).'
    ...
    $html2=$html2 .'I  CERTIFY on my honor that  the  above  is  a  true  and correct';
    $html2= $html2 .'<br>report <i> of <i> the <i> hours <i> of <i> work <i> performed, <i> record <i> of <i>which';
    $html2= $html2 .'<br> was made daily at the  time of arrival and';
    $html2=$html2.' departure from';
    $html2=$html2. '<br>office.</i> </p>';
	$html2=$html2.' <p style="padding-top: -12px; text-align:left; font-family:arial; font-size: 10px"> '. str_repeat("&nbsp;", 36).''.str_repeat("_",36).'</p>
...
$html2 =$html2.'<br><p style="text-align:left; padding-top:-10px; font-family:arial; font-size:-1px">' .str_repeat("&nbsp;",$spc0). '<u><b>' .$head. '<b></u><br>'.str_repeat("&nbsp;",$ee). ''.$head1 .'</p>
